...
const App = () => {
    ...
    const stats = [
        {
            ...
            icon: (
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-blue-400"><path d="M20 4H4c-1.11 0-1.99.89-1.99 2L2 18c0 1.11.89 2 2 2h16c1.11 0 2-.89 2-2V6c0-1.11-.89-2-2-2zm0 14H4v-6h16v6zm0-10H4V6h16v2z" /></svg>
            ),
        ...
        },
        {
            ...
            icon: (
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-cyan-400"><path d="M21 18H3V6h18v12zm0-14H3c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h18c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2z" /><path d="M12 11h2v2h-2v-2z" /></svg>
            ),
        ...
        },
        {
            ...
            subtextColor: 'text-slate-500',
            icon: (
                <svg viewBox="0 0 24 24" className="w-5 h-5 fill-indigo-400"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V5h14v14z" /><path d="M7 12h2v7H7v-7zm4-3h2v10h-2V9zm4 6h2v4h-2v-4z" /></svg>
            ),
    ...
    const subscriptions = [
        { name: 'Netflix', price: '$10.99/mo', color: 'bg-[#E50914]', url: 'https://netflix.com', icon: <span className="text-white font-black text-xl italic leading-none">N</span> },
        { name: 'YouTube Premium', price: '$11.99/mo', color: 'bg-white', url: 'https://youtube.com/premium', icon: <svg viewBox="0 0 24 24" className="w-6 h-6 fill-red-600"><path d="M23.5 6.2c-.3-1.1-1.1-2-2.2-2.3C19.3 3.5 12 3.5 12 3.5s-7.3 0-9.3.5c-1.1.3-1.9 1.2-2.2 2.3C0 8.2 0 12.4 0 12.4s0 4.2.5 6.2c.3 1.1 1.1 2 2.2 2.3 2 0.5 9.3 0.5 9.3 0.5s7.3 0 9.3-.5c1.1-.3 1.9-1.2 2.2-2.3.5-2 .5-6.2.5-6.2s0-4.2-.5-6.2zM9.5 15.4V9.4l6.2 3-6.2 3z" /></svg> },
        { name: 'Disney+', price: '$13.99/mo', color: 'bg-[#020731]', url: 'https://disneyplus.com', icon: <span className="text-white font-serif italic text-lg font-black leading-none text-center">D+</span> },
        { name: 'Spotify Premium', price: '$14.99/mo', color: 'bg-[#1DB954]', url: 'https://spotify.com', icon: <svg viewBox="0 0 24 24" className="w-7 h-7 fill-black"><path d="M12 0C5.4 0 0 5.4 0 12s5.4 12 12 12 12-5.4 12-12S18.6 0 12 0zm5.5 17.3c-.2.4-.7.5-1.1.3-2.8-1.7-6.3-2.1-10.4-1.2-.5.1-.9-.2-1-.7s.2-.9.7-1c4.5-1 8.4-.6 11.5 1.3.4.2.5.8.3 1.3zm1.4-3.3c-.3.5-.9.6-1.4.3-3.2-2-8.1-2.5-11.9-1.4-.6.2-1.2-.2-1.3-.8s.2-1.2.8-1.3c4.4-1.3 9.8-.7 13.5 1.6.5.3.6.9.3 1.6zm.1-3.4c-3.9-2.3-10.3-2.5-14.1-1.4-.6.2-1.2-.2-1.4-.8s.2-1.2.8-1.4c4.3-1.3 11.4-1 15.9 1.6.5.3.7 1 .4 1.5-.3.5-1 .7-1.6.5z" /></svg> },
        { name: 'Microsoft 365', price: '$12.99/mo', color: 'bg-[#00a1f1]', url: 'https://microsoft.com', icon: <svg viewBox="0 0 24 24" className="w-5 h-5 fill-white"><path d="M0 12.1L10.1 10.7V0L0 1.5V12.1ZM11.1 10.5L24 8.7V0L11.1 1.8V10.5ZM11.1 13.5L24 15.3V24L11.1 22.2V13.5ZM0 22.5L10.1 24V13.3L0 11.9V22.5Z" /></svg> },
        { name: 'Canva Pro', price: '$12.99/mo', color: 'bg-[#7d2ae8]', url: 'https://canva.com', icon: <span className="text-white font-bold italic text-[10px]">Canva</span> },
        { name: 'Dropbox', price: '$9.99/mo', color: 'bg-[#0061FF]', url: 'https://dropbox.com', icon: <svg viewBox="0 0 24 24" className="w-6 h-6 fill-white"><path d="M6 1.9l6 3.8-6 3.8L0 5.7l6-3.8zm0 13l6-3.8 6 3.8-6 3.8-6-3.8zm12-9.2l6 3.8-6 3.8-6-3.8 6-3.8zM0 9.5l6 3.8-6 3.8V9.5zm24 0v7.6l-6-3.8 6-3.8z" /></svg> },
        { name: 'Slack', price: '$11.99/mo', color: 'bg-white', url: 'https://slack.com', icon: <svg viewBox="0 0 24 24" className="w-6 h-6"><path d="M5 12.5c0 1.4-1.1 2.5-2.5 2.5S0 13.9 0 12.5s1.1-2.5 2.5-2.5H5v2.5zm1.2 0c0-1.4 1.1-2.5-2.5-2.5s2.5 1.1 2.5 2.5V19c0 1.4-1.1 2.5-2.5 2.5S6.2 20.4 6.2 19v-6.5z" fill="#36C5F0" /><path d="M11.5 5c-1.4 0-2.5-1.1-2.5-2.5S10.1 0 11.5 0s2.5 1.1 2.5 2.5V5h-2.5zm0 1.2c1.4 0 2.5 1.1 2.5 2.5s-1.1 2.5-2.5 2.5H5c-1.4 0-2.5-1.1-2.5-2.5S3.6 6.2 5 6.2h6.5z" fill="#2EB67D" /></svg> },
    ];
                    ...
                    {[
                        ...
                        return (
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-5 py-3.5 rounded-2xl transition-all duration-300 relative group overflow-hidden ${isSelected
                                        ? 'text-blue-400'
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                    ...
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-4">
                            ...
                            >
                                ...
                                <div className="absolute -top-1 -right-1 w-2 h-2 bg-pink-500 rounded-full border-2 border-[#060608]"></div>
                            </div>
                            <div
                            ...
                            >
                                ...
                                <span className="text-sm font-semibold text-slate-300 group-hover:text-white transition-colors">Sarah Jenkins</span>
                ...
                <div className="flex-1 overflow-y-auto px-10 pt-8 pb-12 custom-scrollbar">
                    ...
                    <div className="grid grid-cols-4 gap-4 mb-10">
                        {stats.map((stat, i) => (
                            <div key={i} className={`bg-[#0d0d10] border ${stat.glow} rounded-2xl p-5 flex items-start justify-between relative transition-all hover:scale-[1.02]`}>
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        {stat.hasChart && (
                                            <svg viewBox="0 0 40 10" className="w-8 h-3 stroke-cyan-400 fill-none opacity-60"><path d="M0 8 Q 10 2, 20 6 T 40 0" strokeWidth="2" /></svg>
                                        )}
                                    </div>
                                </div>
                    ...
                    <div className="w-full">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            {subscriptions.map((sub, i) => {
                                const isActive = i < 7;
                                return (
                                    <div key={i} className="bg-[#0d0d10] border border-white/5 px-4 py-3.5 rounded-2xl flex items-center group hover:bg-[#121216] hover:border-white/20 hover:shadow-[0_8px_30px_rgba(0,0,0,0.4)] transition-all">
                                        <div className={`w-11 h-11 rounded-xl ${sub.color} flex items-center justify-center shadow-[0_4px_12px_rgba(0,0,0,0.5)] shrink-0 transition-transform group-hover:scale-105`}>
                                            {sub.icon}
                                        </div>
                                        ...
                                        <div className="ml-4 flex-1">
                                            <div className="flex flex-col">
                                                <div className="flex items-center gap-2">
                                                    <h4 className="font-bold text-[14px] leading-tight group-hover:text-blue-400 transition-colors">{sub.name}</h4>
                                                    <span className={`text-[8px] font-black uppercase tracking-[0.12em] ${isActive ? 'text-green-500 drop-shadow-[0_0_8px_rgba(34,197,94,0.3)]' : 'text-slate-600'}`}>
                                                        • {isActive ? 'Active' : 'Expired'}
                                                    </span>
                                                </div>
                                                <span className="text-slate-400 text-xs font-medium mt-0.5">{sub.price}</span>
                                            </div>
                                        </div>
                                        ...
                                        <button
                                            onClick={() => {
                                                if (isActive) {
                                                    router.push(`/manage?id=${sub.name.toLowerCase().replace(/\s+/g, '-')}`);
                                                } else {
                                                    window.open(sub.url, "_blank");
                                                }
                                            }}
                                            className={`px-4 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest shrink-0 transition-all ${isActive
